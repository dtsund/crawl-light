                           ...
                           iflags_t ignore_flags) const
{
    ...
    if (this->base_type == OBJ_MISCELLANY
        ...
        || this->sub_type == MISC_HELL_KEY) || is_artefact(*this))
    {
...
static const char* scroll_type_name(int scrolltype)
{
    ...
    case SCR_FORBIDDEN_KNOWLEDGE: return "forbidden knowledge";
    default:                     return "bugginess";
    }
}
...
static const char* _book_type_name(int booktype)
{
    ...
    case BOOK_BRANDS:                 return "Distance";
    ...
    */
    ...
    case OBJ_MISCELLANY:
        ...
        else
        {
            ...
            buff << misc_type_name(item_typ, true);
    ...
    // Disambiguation.
    if (!terse && !basename && !dbname && !is_artefact(*this))
    {
