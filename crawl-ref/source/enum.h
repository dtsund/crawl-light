...
enum monster_type                      // (int) menv[].type
{
    ...
    // Random uniques:
    MONS_IJYB,
    MONS_FIRST_EASY_UNIQUE = MONS_IJYB,
    MONS_JESSICA,
    MONS_SIGMUND,
    MONS_TERENCE,
    MONS_BLORK_THE_ORC,
    ...
    MONS_CRAZY_YIUF,
    MONS_GRINDER,
    MONS_LAST_EASY_UNIQUE = MONS_GRINDER,
    MONS_EROLCHA,
    MONS_FIRST_HARD_UNIQUE = MONS_EROLCHA,
    MONS_AGNES,
    MONS_RUPERT,
    MONS_XTAHUA,
    MONS_FREDERICK,
    ...
    MONS_MARA_FAKE,
    MONS_JORY,
    MONS_LAST_HARD_UNIQUE = MONS_JORY,
    // Sprint uniques:
    MONS_CHUCK,
    MONS_IRON_GIANT,
    MONS_NELLIE,
...
enum skill_type
{
    ...
    SK_SPELLCASTING,
    SK_CONJURATIONS,
    SK_FIRST_MAGIC_SCHOOL = SK_CONJURATIONS,
    SK_ENCHANTMENTS,
    SK_SUMMONINGS,
    SK_NECROMANCY,
    SK_TRANSLOCATIONS,
    ...
    SK_EARTH_MAGIC,
    SK_SORCERY,
    SK_LAST_MAGIC_SCHOOL = SK_SORCERY,
    SK_INVOCATIONS,
    SK_EVOCATIONS,
...
enum daction_type
{
    ...
    DACT_PIKEL_SLAVES,
    DACT_ADD_DIRECTED_ABYSS,
    DACT_SEAL_PANDOORA,
    DACT_UNRESTRICT_DOOR,
    NUM_DACTIONS,
};
