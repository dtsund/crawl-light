...
static void _get_status_lights(std::vector<status_light>& out)
{
    ...
    const int statuses[] = {
        ...
        STATUS_BURDEN, DUR_JELLY_PRAYER, DUR_TELEPORT,
        ...
        STATUS_SICK, STATUS_ROT, STATUS_NET, STATUS_CONTAMINATION, DUR_SWIFTNESS,
        ...
        DUR_FINESSE, DUR_LIFESAVING, DUR_DARKNESS, STATUS_FIREBALL,
        DUR_TORNADO_COOLDOWN, STATUS_BACKLIT, STATUS_UMBRA, DUR_SPAWNING_ILLUSIONS,
		DUR_NAUSEOUS, DUR_IMMOBILE, DUR_ATROPHY, DUR_ISSUING_COMMANDMENT, // DUR_BLIND,
    };
...
static std::string _status_mut_abilities(int sw)
{
    ...
    const int statuses[] = {
        ...
        DUR_POISONING, STATUS_SICK, STATUS_CONTAMINATION, STATUS_ROT,
        ...
        DUR_HEROISM, DUR_FINESSE, DUR_LIFESAVING, DUR_DARKNESS, STATUS_FIREBALL,
        DUR_TORNADO_COOLDOWN, STATUS_BACKLIT, STATUS_UMBRA,
    };
