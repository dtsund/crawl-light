...
{
    _name_pair("abjuration", 131 + 0),
    _name_pair("agony", 96 + 0),
    _name_pair("air_magic_off", 224 + 0),
    _name_pair("air_magic_on", 223 + 0),
    _name_pair("airstrike", 22 + 0),
    _name_pair("alistairs_intoxication", 119 + 0),
    _name_pair("alter_self", 162 + 0),
    _name_pair("animate_dead", 97 + 0),
    _name_pair("animate_skeleton", 98 + 0),
    _name_pair("apportation", 150 + 0),
    _name_pair("armour_off", 190 + 0),
    _name_pair("armour_on", 189 + 0),
    _name_pair("axes_off", 174 + 0),
    _name_pair("axes_on", 173 + 0),
    _name_pair("banishment", 151 + 0),
    _name_pair("berserker_rage", 51 + 0),
    _name_pair("blade_hands", 163 + 0),
    _name_pair("blink", 152 + 0),
    ...
    _name_pair("bows_off", 184 + 0),
    _name_pair("bows_on", 183 + 0),
    _name_pair("call_canine_familiar", 132 + 0),
    _name_pair("call_imp", 133 + 0),
    _name_pair("cause_fear", 52 + 0),
    _name_pair("chain_lightning", 23 + 0),
    _name_pair("charms_off", 210 + 0),
    _name_pair("charms_on", 209 + 0),
    _name_pair("cigotuvis_degeneration", 101 + 0),
    _name_pair("cmd_autofight", 236 + 0),
    _name_pair("cmd_character_dump", 252 + 0),
    _name_pair("cmd_cycle_quiver_forward", 253 + 0),
    _name_pair("cmd_display_character_status", 247 + 0),
    _name_pair("cmd_display_commands", 251 + 0),
    _name_pair("cmd_display_mutations", 245 + 0),
    _name_pair("cmd_display_overmap", 243 + 0),
    _name_pair("cmd_display_religion", 244 + 0),
    _name_pair("cmd_display_skills", 246 + 0),
    _name_pair("cmd_edit_player_tile", 250 + 0),
    _name_pair("cmd_explore", 234 + 0),
    _name_pair("cmd_interlevel_travel", 235 + 0),
    _name_pair("cmd_known_items", 248 + 0),
    _name_pair("cmd_pray", 239 + 0),
    _name_pair("cmd_replay_messages", 241 + 0),
    _name_pair("cmd_resists_screen", 242 + 0),
    _name_pair("cmd_rest", 233 + 0),
    _name_pair("cmd_save_game_now", 249 + 0),
    _name_pair("cmd_search", 237 + 0),
    _name_pair("cmd_search_stashes", 240 + 0),
    _name_pair("cmd_use_ability", 238 + 0),
    _name_pair("condensation_shield", 84 + 0),
    _name_pair("confuse", 53 + 0),
    _name_pair("confusing_touch", 54 + 0),
    _name_pair("conjurations_off", 206 + 0),
    _name_pair("conjurations_on", 205 + 0),
    _name_pair("conjure_ball_lightning", 24 + 0),
    _name_pair("conjure_flame", 70 + 0),
    _name_pair("control_undead", 102 + 0),
    _name_pair("controlled_blink", 153 + 0),
    _name_pair("controlled_teleport", 154 + 0),
    _name_pair("corona", 55 + 0),
    _name_pair("corpse_rot", 103 + 0),
    _name_pair("crossbows_off", 186 + 0),
    _name_pair("crossbows_on", 185 + 0),
    ...
    _name_pair("demonic_horde", 134 + 0),
    _name_pair("dig", 40 + 0),
    _name_pair("dispel_undead", 106 + 0),
    _name_pair("dispersal", 155 + 0),
    _name_pair("dodging_off", 192 + 0),
    _name_pair("dodging_on", 191 + 0),
    _name_pair("dragon_form", 72 + 0),
    _name_pair("earth_magic_off", 226 + 0),
    _name_pair("earth_magic_on", 225 + 0),
    _name_pair("enslavement", 57 + 0),
    _name_pair("ensorcelled_hibernation", 85 + 0),
    _name_pair("error", 255 + 0),
    _name_pair("evaporate", 73 + 0),
    _name_pair("evocations_off", 232 + 0),
    _name_pair("evocations_on", 231 + 0),
    _name_pair("excruciating_wounds", 107 + 0),
    _name_pair("extension", 58 + 0),
    _name_pair("fighting_off", 168 + 0),
    _name_pair("fighting_on", 167 + 0),
    _name_pair("fire_brand", 74 + 0),
    _name_pair("fire_magic_off", 220 + 0),
    _name_pair("fire_magic_on", 219 + 0),
    ...
    _name_pair("hexes_off", 208 + 0),
    _name_pair("hexes_on", 207 + 0),
    _name_pair("homunculus", 165 + 0),
    _name_pair("ice_form", 90 + 0),
    _name_pair("ice_magic_off", 222 + 0),
    _name_pair("ice_magic_on", 221 + 0),
    ...
    _name_pair("invocations_off", 230 + 0),
    _name_pair("invocations_on", 229 + 0),
    ...
    _name_pair("long_blades_off", 172 + 0),
    _name_pair("long_blades_on", 171 + 0),
    _name_pair("maces_flails_off", 176 + 0),
    _name_pair("maces_flails_on", 175 + 0),
    _name_pair("magic_dart", 37 + 0),
    _name_pair("malign_gateway", 135 + 0),
    _name_pair("mass_confusion", 61 + 0),
    _name_pair("memorise", 166 + 0),
    _name_pair("mephitic_cloud", 121 + 0),
    _name_pair("metabolic_englaciation", 92 + 0),
    _name_pair("necromancy_off", 214 + 0),
    _name_pair("necromancy_on", 213 + 0),
    ...
    _name_pair("passage_of_golubria", 156 + 0),
    _name_pair("passwall", 44 + 0),
    _name_pair("petrify", 45 + 0),
    _name_pair("phase_shift", 157 + 0),
    _name_pair("poison_arrow", 123 + 0),
    _name_pair("poison_brand", 124 + 0),
    _name_pair("poison_magic_off", 228 + 0),
    _name_pair("poison_magic_on", 227 + 0),
    _name_pair("poisonous_cloud", 125 + 0),
    _name_pair("polearms_off", 178 + 0),
    _name_pair("polearms_on", 177 + 0),
    _name_pair("polymorph_other", 164 + 0),
    _name_pair("portal_projectile", 158 + 0),
    _name_pair("projected_noise", 62 + 0),
    _name_pair("recall", 136 + 0),
    ...
    _name_pair("shields_off", 198 + 0),
    _name_pair("shields_on", 197 + 0),
    _name_pair("shock", 31 + 0),
    _name_pair("short_blades_off", 170 + 0),
    _name_pair("short_blades_on", 169 + 0),
    _name_pair("silence", 32 + 0),
    _name_pair("simulacrum", 114 + 0),
    _name_pair("slings_off", 182 + 0),
    _name_pair("slings_on", 181 + 0),
    ...
    _name_pair("spellcasting_off", 204 + 0),
    _name_pair("spellcasting_on", 203 + 0),
    _name_pair("spider_form", 127 + 0),
    _name_pair("stabbing_off", 196 + 0),
    _name_pair("stabbing_on", 195 + 0),
    ...
    _name_pair("staves_off", 180 + 0),
    _name_pair("staves_on", 179 + 0),
    _name_pair("stealth_off", 194 + 0),
    _name_pair("stealth_on", 193 + 0),
    _name_pair("sticks_to_snakes", 137 + 0),
    ...
    _name_pair("summon_butterflies", 138 + 0),
    _name_pair("summon_demon", 139 + 0),
    _name_pair("summon_dragon", 140 + 0),
    _name_pair("summon_elemental", 141 + 0),
    _name_pair("summon_greater_demon", 142 + 0),
    _name_pair("summon_horrible_things", 143 + 0),
    _name_pair("summon_hydra", 144 + 0),
    _name_pair("summon_ice_beast", 145 + 0),
    _name_pair("summon_scorpions", 146 + 0),
    _name_pair("summon_shadow_creatures", 147 + 0),
    _name_pair("summon_small_mammals", 148 + 0),
    _name_pair("summon_ugly_thing", 149 + 0),
    _name_pair("summonings_off", 212 + 0),
    _name_pair("summonings_on", 211 + 0),
    _name_pair("sure_blade", 65 + 0),
    _name_pair("swiftness", 34 + 0),
    _name_pair("symbol_of_torment", 116 + 0),
    _name_pair("tab_command", 271 + 0),
    _name_pair("tab_item", 256 + 0),
    _name_pair("tab_memorise", 262 + 0),
    _name_pair("tab_monster", 265 + 0),
    _name_pair("tab_skill", 268 + 0),
    _name_pair("tab_spell", 259 + 0),
    _name_pair("tavern", 9 + 0),
    _name_pair("teleport", 159 + 0),
    _name_pair("teleport_other", 160 + 0),
    _name_pair("throw_flame", 81 + 0),
    _name_pair("throw_frost", 95 + 0),
    _name_pair("throw_icicle", 89 + 0),
    _name_pair("throwing_off", 188 + 0),
    _name_pair("throwing_on", 187 + 0),
    _name_pair("todo", 254 + 0),
    _name_pair("tornado", 35 + 0),
    _name_pair("translocations_off", 216 + 0),
    _name_pair("translocations_on", 215 + 0),
    _name_pair("transmutations_off", 218 + 0),
    _name_pair("transmutations_on", 217 + 0),
    _name_pair("traps_doors_off", 200 + 0),
    _name_pair("traps_doors_on", 199 + 0),
    _name_pair("tukimas_dance", 66 + 0),
    _name_pair("twisted_resurrection", 117 + 0),
    _name_pair("unarmed_combat_off", 202 + 0),
    _name_pair("unarmed_combat_on", 201 + 0),
    _name_pair("vampiric_draining", 118 + 0),
    _name_pair("venom_bolt", 129 + 0),
    _name_pair("warp_weapon", 161 + 0),
};
