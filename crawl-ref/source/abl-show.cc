...
struct ability_def
{
    ...
    unsigned int        glow_cost;      // glow incurred through use
...
//
// The four numerical fields are: MP, HP, glow, and piety.
...
static const ability_def Ability_List[] =
{
    ...
    { ABIL_HELLFIRE, "Hellfire", 0, 250, 2, 0, ABFLAG_NONE },
    { ABIL_THROW_FLAME, "Throw Flame", 0, 20, 1, 0, ABFLAG_NONE },
    { ABIL_THROW_FROST, "Throw Frost", 0, 20, 1, 0, ABFLAG_NONE },
    ...
    { ABIL_FLY_II, "Fly", 0, 0, 1, 0, ABFLAG_NONE },
    ...
    { ABIL_ZIN_IMPRISON, "Imprison", 5, 0, 0, 4, ABFLAG_NONE },
    { ABIL_ZIN_SANCTUARY, "Sanctuary", 7, 0, 0, 15, ABFLAG_NONE },
    { ABIL_ZIN_CURE_ALL_MUTATIONS, "Cure All Mutations",
      0, 0, 0, 0, ABFLAG_NONE },
    { ABIL_ZIN_ISSUE_EDICT, "Issue Edict", 0, 0, 0, 15, ABFLAG_NONE },
    { ABIL_ZIN_ABSOLUTION, "Absolution", 0, 0, 0, 6, ABFLAG_NONE },
    { ABIL_ZIN_ISSUE_COMMANDMENT, "Issue Commandment", 12, 0, 0, 15, ABFLAG_NONE },

    // The Shining One
    { ABIL_TSO_DIVINE_SHIELD, "Divine Shield", 3, 0, 1, 2, ABFLAG_NONE },
    { ABIL_TSO_CLEANSING_FLAME, "Cleansing Flame", 5, 0, 1, 2, ABFLAG_NONE },
    { ABIL_TSO_SUMMON_DIVINE_WARRIOR, "Summon Divine Warrior",
      8, 0, 2, 6, ABFLAG_NONE },

    // Kikubaaqudgha
    { ABIL_KIKU_RECEIVE_CORPSES, "Receive Corpses", 3, 0, 1, 2, ABFLAG_NONE },
    { ABIL_KIKU_TORMENT, "Torment", 4, 0, 0, 8, ABFLAG_NONE },

    // Yredelemnul
    { ABIL_YRED_INJURY_MIRROR, "Injury Mirror", 0, 0, 0, 0, ABFLAG_PIETY },
    { ABIL_YRED_ANIMATE_REMAINS, "Animate Remains", 2, 0, 1, 0, ABFLAG_NONE },
    { ABIL_YRED_RECALL_UNDEAD_SLAVES, "Recall Undead Slaves",
      2, 0, 1, 0, ABFLAG_NONE },
    { ABIL_YRED_ANIMATE_DEAD, "Animate Dead", 2, 0, 1, 0, ABFLAG_NONE },
    { ABIL_YRED_DRAIN_LIFE, "Drain Life", 6, 0, 2, 2, ABFLAG_NONE },
    { ABIL_YRED_ENSLAVE_SOUL, "Enslave Soul", 8, 0, 2, 4, ABFLAG_NONE },
    ...
    { ABIL_TROG_BROTHERS_IN_ARMS, "Brothers in Arms",
      0, 0, 1, generic_cost::range(5, 6), ABFLAG_NONE },

    // Elyvilon
    { ABIL_ELYVILON_LIFESAVING, "Divine Protection",
      0, 0, 0, 0, ABFLAG_NONE },
    { ABIL_ELYVILON_LESSER_HEALING_SELF, "Lesser Self-Healing",
      1, 0, 1, generic_cost::range(0, 1), ABFLAG_CONF_OK },
    { ABIL_ELYVILON_LESSER_HEALING_OTHERS, "Lesser Healing",
      1, 0, 1, 0, ABFLAG_CONF_OK },
    { ABIL_ELYVILON_PURIFICATION, "Purification", 3, 0, 2, 3,
      ABFLAG_CONF_OK },
    ...
    { ABIL_LUGONU_CORRUPT, "Corrupt",
      7, scaling_cost::fixed(5), 3, generic_cost::range(10, 14), ABFLAG_NONE },
    { ABIL_LUGONU_ABYSS_ENTER, "Enter the Abyss",
      9, 0, 3, generic_cost::fixed(35), ABFLAG_PAIN },

    // Nemelex
    { ABIL_NEMELEX_DRAW_ONE, "Draw One", 2, 0, 0, 0, ABFLAG_NONE },
    { ABIL_NEMELEX_PEEK_TWO, "Peek at Two", 3, 0, 0, 1, ABFLAG_INSTANT },
    { ABIL_NEMELEX_TRIPLE_DRAW, "Triple Draw", 2, 0, 1, 2, ABFLAG_NONE },
    { ABIL_NEMELEX_MARK_FOUR, "Mark Four", 4, 0, 0, 5, ABFLAG_NONE },
    { ABIL_NEMELEX_STACK_FIVE, "Stack Five", 5, 0, 0, 10, ABFLAG_NONE },
    ...
    { ABIL_JIYVA_SLIMIFY, "Slimify", 4, 0, 1, 8, ABFLAG_NONE },
    { ABIL_JIYVA_CURE_BAD_MUTATION, "Cure Bad Mutation",
      8, 0, 2, 15, ABFLAG_NONE },

    // Fedhas
    { ABIL_FEDHAS_EVOLUTION, "Evolution", 2, 0, 0, 0, ABFLAG_VARIABLE_FRUIT},
    { ABIL_FEDHAS_SUNLIGHT, "Sunlight", 2, 0, 1, 0, ABFLAG_NONE},
    { ABIL_FEDHAS_PLANT_RING, "Growth", 2, 0, 0, 0, ABFLAG_FRUIT},
    { ABIL_FEDHAS_SPAWN_SPORES, "Reproduction", 4, 0, 1, 0, ABFLAG_NONE},
    { ABIL_FEDHAS_RAIN, "Rain", 4, 0, 1, 4, ABFLAG_NONE},

    // Cheibriados
    { ABIL_CHEIBRIADOS_PONDEROUSIFY, "Make Ponderous",
      0, 0, 0, 0, ABFLAG_NONE },
    { ABIL_CHEIBRIADOS_TIME_BEND, "Bend Time", 3, 0, 1, 1, ABFLAG_NONE },
    { ABIL_CHEIBRIADOS_SLOUCH, "Slouch", 5, 0, 1, 8, ABFLAG_NONE },
    { ABIL_CHEIBRIADOS_TIME_STEP, "Step From Time",
      10, 0, 2, 10, ABFLAG_NONE },

    // Ashenzari
    { ABIL_ASHENZARI_SCRYING, "Scrying",
      4, 0, 1, generic_cost::range(5, 6), ABFLAG_INSTANT },
    ...
    { ABIL_MAKE_ICE_STATUE, "Make ice statue", 0, 0, 1, 0, ABFLAG_NONE, 2000},
    { ABIL_MAKE_OCS, "Make crystal statue", 0, 0, 2, 0, ABFLAG_NONE, 2000},
    { ABIL_MAKE_SILVER_STATUE, "Make silver statue", 0, 0, 3, 0, ABFLAG_NONE, 3000},
    { ABIL_MAKE_CURSE_SKULL, "Make curse skull", 0, 0, 3, 0, ABFLAG_NECRO_MISCAST_MINOR, 10000},
    ...
    { ABIL_MAKE_SAGE, "Sage", 0, 0, 2, 0,  ABFLAG_INSTANT, 0 },
    { ABIL_REMOVE_CURSE, "Remove Curse", 0, 0, 2, 0, ABFLAG_STAT_DRAIN, 0 },
