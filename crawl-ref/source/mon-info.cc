    ...
    else
    {
        ...
        case MONS_DANCING_WEAPON:
            if (inv[MSLOT_WEAPON].get())
            {
                ...
                s = (item.name(DESC_NO_ARTICLE, false, false, use_inscrip, false,
                                  ignore_flags));
            }
            break;
                                  ...
                                  int& desc_color, bool fullname) const
{
    ...
    case ATT_HOSTILE:
        ...
        case MTHRT_UNDEF:   desc_color = MAGENTA;   break; //hopefully never
        }
        break;
    }
...
/* Unimplemented feature, and needed to make space
