...
static std::vector<monster_type> _find_valid_monster_types(const level_id &place)
{
    ...
    for (int i = 0; i < NUM_MONSTERS; ++i)
        ...
        {
            if (i == MONS_STAIR_MIMIC)
                continue;
            if (i == MONS_SHOP_MIMIC)
                continue;
                                 ...
                                 bool force_normal)
{
    ...
    *isood = false;
    ...
    if (is_connected_branch(place) && lev_mons <= 18 && 
        ...
        || place == BRANCH_ABYSS)
    {
        do
        {
            ...
            do
            {
                ...
                while (mons_abyss_level(mon_type) == 0 && count < 2000);
                              ...
                              bool dont_place)
{
    ...
    // 6 out of 7 demons in the Abyss belong to Lugonu, and 6 out of 7 in Hell
    // belong to Makhleb.
                              ...
                              bool &natural_leader)
{
    ...
    case MONS_PALE_DRACONIAN:
        if (power > 12 && one_chance_in(3) && player_in_connected_branch())
        {
            band = BAND_DRACONIAN;
    ...
    case MONS_DRACONIAN_SHIFTER:
        if ((power > 14 && player_in_connected_branch()) || player_in_hard_mode())
        {
            band = BAND_DRACONIAN;
