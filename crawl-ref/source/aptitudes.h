...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_SLUDGE_ELF,      SK_SORCERY,         1),
    ...
    APT(SP_MOUNTAIN_DWARF,  SK_SORCERY,        -2),
    ...
    APT(SP_RED_DRACONIAN,   SK_SORCERY,         0),
    ...
    APT(SP_WHITE_DRACONIAN, SK_SORCERY,         0),
    ...
    APT(SP_GREEN_DRACONIAN, SK_SORCERY,         2),
    ...
    APT(SP_YELLOW_DRACONIAN,SK_SORCERY,         0),
    ...
    APT(SP_GREY_DRACONIAN,  SK_SORCERY,         0),
    ...
    APT(SP_BLACK_DRACONIAN, SK_SORCERY,         0),
    ...
    APT(SP_PURPLE_DRACONIAN,SK_SORCERY,         0),
    ...
    APT(SP_MOTTLED_DRACONIAN,SK_SORCERY,         0),
    ...
    APT(SP_PALE_DRACONIAN,  SK_SORCERY,         0),
    ...
    APT(SP_BASE_DRACONIAN,  SK_SORCERY,         0),
    ...
    APT(SP_CENTAUR,         SK_SORCERY,        -1),
    APT(SP_CENTAUR,         SK_INVOCATIONS,     0),
    APT(SP_CENTAUR,         SK_EVOCATIONS,     -1),

    //Had to mangle the below, even while commented out,
    //to suppress gen-apt.pl from writing demigod aptitudes.
/*
    // SP_DEMIGOD
    A PT(SP_DEMIGOD,         SK_FIGHTING,       -1),
    A PT(SP_DEMIGOD,         SK_SHORT_BLADES,   -1),
    A PT(SP_DEMIGOD,         SK_LONG_BLADES,    -1),
    A PT(SP_DEMIGOD,         SK_AXES,           -1),
    A PT(SP_DEMIGOD,         SK_MACES_FLAILS,   -1),
    A PT(SP_DEMIGOD,         SK_POLEARMS,       -1),
    A PT(SP_DEMIGOD,         SK_STAVES,         -1),
    A PT(SP_DEMIGOD,         SK_SLINGS,         -1),
    A PT(SP_DEMIGOD,         SK_BOWS,           -1),
    A PT(SP_DEMIGOD,         SK_CROSSBOWS,      -1),
    A PT(SP_DEMIGOD,         SK_THROWING,       -1),
    A PT(SP_DEMIGOD,         SK_ARMOUR,         -1),
    A PT(SP_DEMIGOD,         SK_DODGING,        -1),
    A PT(SP_DEMIGOD,         SK_STEALTH,        -1),
    A PT(SP_DEMIGOD,         SK_STABBING,       -1),
    A PT(SP_DEMIGOD,         SK_SHIELDS,        -1),
    A PT(SP_DEMIGOD,         SK_TRAPS_DOORS,    -1),
    A PT(SP_DEMIGOD,         SK_UNARMED_COMBAT, -1),
    A PT(SP_DEMIGOD,         SK_SPELLCASTING,   -1),
    A PT(SP_DEMIGOD,         SK_CONJURATIONS,   -1),
    A PT(SP_DEMIGOD,         SK_ENCHANTMENTS,   -1),
    A PT(SP_DEMIGOD,         SK_SUMMONINGS,     -1),
    A PT(SP_DEMIGOD,         SK_NECROMANCY,     -1),
    A PT(SP_DEMIGOD,         SK_TRANSLOCATIONS, -1),
    A PT(SP_DEMIGOD,         SK_TRANSMUTATIONS, -1),
    A PT(SP_DEMIGOD,         SK_FIRE_MAGIC,     -1),
    A PT(SP_DEMIGOD,         SK_ICE_MAGIC,      -1),
    A PT(SP_DEMIGOD,         SK_AIR_MAGIC,      -1),
    A PT(SP_DEMIGOD,         SK_EARTH_MAGIC,    -1),
    A PT(SP_DEMIGOD,         SK_SORCERY,        -1),
    A PT(SP_DEMIGOD,         SK_INVOCATIONS,     0),
    A PT(SP_DEMIGOD,         SK_EVOCATIONS,     -1),
*/
    ...
    APT(SP_DEMONSPAWN,      SK_SORCERY,         0),
    ...
    APT(SP_DEEP_DWARF,      SK_SORCERY,        -2),
    APT(SP_DEEP_DWARF,      SK_INVOCATIONS,     2),
    APT(SP_DEEP_DWARF,      SK_EVOCATIONS,      3),

    //Had to mangle the below, even while commented out,
    //to suppress gen-apt.pl from writing felid aptitudes.
    // SP_CAT
    //A PT(SP_CAT,             SK_FIGHTING,       -2),
    //A PT(SP_CAT,             SK_SHORT_BLADES,    0),
    //A PT(SP_CAT,             SK_LONG_BLADES,     0),
    //A PT(SP_CAT,             SK_AXES,            0),
    //A PT(SP_CAT,             SK_MACES_FLAILS,    0),
    //A PT(SP_CAT,             SK_POLEARMS,        0),
    //A PT(SP_CAT,             SK_STAVES,          0),
    //A PT(SP_CAT,             SK_SLINGS,          0),
    //A PT(SP_CAT,             SK_BOWS,            0),
    //A PT(SP_CAT,             SK_CROSSBOWS,       0),
    //A PT(SP_CAT,             SK_THROWING,        0),
    //A PT(SP_CAT,             SK_ARMOUR,          0),
    //A PT(SP_CAT,             SK_DODGING,         2),
    //A PT(SP_CAT,             SK_STEALTH,         2),
    //A PT(SP_CAT,             SK_STABBING,        3),
    //A PT(SP_CAT,             SK_SHIELDS,         0),
    //A PT(SP_CAT,             SK_TRAPS_DOORS,     2),
    //A PT(SP_CAT,             SK_UNARMED_COMBAT, -2),
    //A PT(SP_CAT,             SK_SPELLCASTING,    0),
    //A PT(SP_CAT,             SK_CONJURATIONS,   -1),
    //A PT(SP_CAT,             SK_ENCHANTMENTS,    3), //PLACEHOLDER FOR FELID
    //A PT(SP_CAT,             SK_SUMMONINGS,      1),
    //A PT(SP_CAT,             SK_NECROMANCY,      0),
    //A PT(SP_CAT,             SK_TRANSLOCATIONS,  2),
    //A PT(SP_CAT,             SK_TRANSMUTATIONS,  1),
    //A PT(SP_CAT,             SK_FIRE_MAGIC,     -1),
    //A PT(SP_CAT,             SK_ICE_MAGIC,      -2),
    //A PT(SP_CAT,             SK_AIR_MAGIC,      -1),
    //A PT(SP_CAT,             SK_EARTH_MAGIC,    -2),
    //A PT(SP_CAT,             SK_SORCERY,        -1),
    //A PT(SP_CAT,             SK_INVOCATIONS,    -1),
    //A PT(SP_CAT,             SK_EVOCATIONS,     -2),
};
