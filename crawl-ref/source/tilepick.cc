...
static tileidx_t _tileidx_feature_base(dungeon_feature_type feat)
{
    ...
    case DNGN_ENTER_ABYSS_DIRECTED:
        return TILE_DNGN_ENTER_ABYSS_DIRECTED;
                                       ...
                                       int number, int tile_num_prop)
{
    ...
    case MONS_SILENT_DISCIPLE:
        return TILEP_MONS_SILENT_DISCIPLE;
    ...
    case MONS_SCREAMING_STATUE:
        return TILEP_MONS_SCREAMING_STATUE;
...
tileidx_t tileidx_skill(skill_type skill, bool active)
{
    ...
    case SK_SORCERY:        ch = TILEG_HEXES_ON; break;
...
tileidx_t tileidx_gametype(const game_type gtype)
{
    ...
    case GAME_TYPE_CHALLENGE:
        return TILEG_STARTUP_CHALLENGE;
