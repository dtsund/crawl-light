 ...
 - Here are the rows:
    ...
    - row 6: hit dice, described by four parameters (hd, min, rand, bonus)
             HP will be hd * min + (0..rand) + (0..rand) + (0..rand) + bonus
                                    \\\\\\\\\\\hd times////////////
    - row 7: AC, evasion, sec(spell), abil, corpse_thingy, zombie size, shouts
 ...
 - Some further explanations:
   ...
   - hit dice, min hp per HD, extra random hp per HD, fixed HP (unique mons)
    ...
    sec: if the monster has only one possible spellbook, sec is set to that book.
         If a monster has multiple possible books, sec is set to MST_NO_SPELLS.
         Then the function _get_spellbook_list in mon-util.cc checks for the
         flag M_SPELLCASTER, and handles the books.
...
// It is also a good prototype for new monsters.
{
    ...
    // hit points
    { 0, 0, 0, 0 },
    // AC, EV, spells, abil, corpse type, zombie size, shout type, intelligence
    0, 0, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT,
...
// ants ('a')
{
    ...
    { 3, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { 13, 3, 5, 0 },
    14, 3, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SILENT,
...

{
    ...
    { 6, 3, 5, 0 },
    8, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 2, 3, 5, 0 },
    2, 6, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...
{ // dummy, used for redefining and player (non-vampire) form
    ...
    { 1, 2, 3, 0 },
    1, 14, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 5, 0 },
    0, 25, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
{ // one vault + player transform (Vp ability)
    ...
    { 3, 2, 3, 0 },
    1, 14, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 30, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...

{
    ...
    { 6, 4, 3, 0 },
    1, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_CAW,
...

{
    ...
    { 13, 6, 5, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SCREECH,
...
// centaurs ('c')
{
    ...
    { 4, 3, 5, 0 },
    3, 7, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SHOUT,
...

{
    ...
    { 9, 3, 5, 0 },
    4, 8, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 8, 3, 5, 0 },
    4, 4, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SHOUT,
...

{
    ...
    { 14, 3, 5, 0 },
    5, 5, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_BIG
},
...
{   // Base draconian - for use like MONS_HUMAN, MONS_ELF although we
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 6, 4, 0 },
    9, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_ROAR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    9, 10, MST_NO_SPELLS, MABIL_SPIT_ACID, CE_CONTAMINATED, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    9, 14, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_TAIL_SLAP, AF_POISON, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 14, 5, 4, 0 },
    9, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    8, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 5, 4, 0 },
    9, 10, MST_NO_SPELLS, MABIL_DRACONIAN_BREATH, CE_CONTAMINATED, Z_SMALL,
        S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_TAIL_SLAP, AF_PLAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 14, 5, 4, 0 },
    16, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 3, 0 },
    9, 10, MST_DRAC_CALLER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 16, 6, 3, 0 },
    6, 20, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    12, 10, MST_DEEP_ELF_HIGH_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 4, 0 },
    8, 16, MST_DRAC_SHIFTER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    8, 10, MST_DEEP_ELF_ANNIHILATOR, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 6, 4, 0 },
    12, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 2, 0 },
    8, 12, MST_DRAC_SCORCHER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
//mv: have to exist because it's (and should be) a valid polymorph target.
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 3, 0 },
    2, 14, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 3, 3, 3, 0 },
    0, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 6, 3, 3, 0 },
    0, 13, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 11, 3, 3, 0 },
    0, 15, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 16, 5, 3, 0 },
    0, 25, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_SUMMONER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 3, 3, 0 },
    3, 13, MST_DEEP_ELF_HIGH_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 12, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_DEMONOLOGIST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_ANNIHILATOR, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_SORCERER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 3, 3, 0 },
    0, 13, MST_DEEP_ELF_DEATH_MAGE, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// fungi ('f')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 2, 2, 0 },
    1, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 0, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...

{
    ...
    { 8, 3, 5, 0 },
    5, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// goblins ('g')
{
    ...
    { 1, 2, 4, 0 },
    0, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 4, 3, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 4, 5, 0 },
    2, 9, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 4, 5, 0 },
    2, 9, MST_GNOLL_SHAMAN, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 4, 4, 5, 0 },
    2, 9, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    0, 12, MST_BOGGART, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...
{ // one vault.  Polymorph disabled.
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},
...
// hounds and hogs ('h')
{
    ...
    { 1, 3, 5, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_BARK,
...

{
    ...
    { 3, 3, 5, 0 },
    2, 13, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_BARK,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 12}, {AT_CLAW, AF_PLAIN, 3}, {AT_CLAW, AF_PLAIN, 3},
       AT_NO_ATK },
    { 4, 4, 5, 0 },
    4, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_BARK,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 2}, {AT_CLAW, AF_PLAIN, 2},
       AT_NO_ATK },
    { 4, 3, 5, 0 },
    3, 15, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_BARK,
...

{
    ...
    { 4, 3, 5, 0 },
    4, 15, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 17, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 6, 3, 5, 0 },
    2, 9, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_LAND, FL_NONE, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 5, 3, 5, 0 },
    6, 13, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_POISON_CONTAM, Z_SMALL, S_BARK,
    I_ANIMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 11, 3, 5, 0 },
    2, 9, MST_HELL_HOG, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_LAND, FL_NONE, 14, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...
{   // a dummy monster for recolouring
    ...
    { 5, 2, 3, 0 },
    2, 18, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_HISS,
...
// spriggans ('i')
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 2, 2, 0 },
    1, 20, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
...
{   // both the guy and his ride as one monster
    ...
    { 11, 3, 2, 0 },
    1, 16, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 2, 2, 0 },
    1, 25, MST_SPRIGGAN_DRUID, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 2, 2, 0 },
    2, 25, MST_BK_TROG, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 2, 2, 0 },
    1, 25, MST_SPRIGGAN_AIR_MAGE, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { 15, 2, 2, 0 },
    3, 30, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { 15, 2, 2, 0 },
    1, 40, MST_THE_ENCHANTRESS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},
...
// slugs ('j')
{
    ...
    { 10, 5, 3, 0 },
    0, 2, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SILENT,
...

{
    ...
    { 14, 5, 3, 0 },
    7, 2, MST_NO_SPELLS, MABIL_WITHDRAW, CE_POISONOUS, Z_BIG, S_SILENT,
...

{
    ...
    { 20, 5, 3, 0 },
    2, 1, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SILENT,
...
// killer bees ('k')
{
    ...
    { {AT_STING, AF_POISON_NASTY, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    10, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 3, 3, 5, 0 },
    2, 18, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_BUZZ,
...

{
    ...
    { 7, 3, 5, 0 },
    4, 15, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_BUZZ,
    I_INSECT, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},

{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 5, 0 },
    1, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 7, 2, 2, 0 },
    1, 18, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SILENT,
...
// lizards ('l')
{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 2, 0 },
    0, 15, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { 3, 3, 5, 0 },
    5, 9, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_HISS,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 4, 4, 0 },
    3, 12, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_HISS,
    I_REPTILE, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 8, 3, 5, 0 },
    7, 8, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_HISS,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// drakes (also 'l', but dragon type)
{
    ...
    { {AT_BITE, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 5, 5, 0 },
    3, 11, MST_SWAMP_DRAKE, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_ROAR,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
    3, 12, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_CONTAMINATED, Z_BIG, S_SILENT,
...

{
    ...
    { 9, 3, 5, 0 },
    8, 6, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_CLEAN, Z_BIG, S_ROAR,
    I_REPTILE, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 5, 7, 0 },
    6, 14, MST_DEATH_DRAKE, MABIL_NONE, CE_ROT, Z_BIG, S_ROAR,
...
// merfolk ('m')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 2, 4, 0 },
    4, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
...

{
    ...
    0, 18, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_SHOOT, AF_PLAIN, 9}, {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK },
    { 8, 2, 4, 0 },
    0, 14, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 15, 3, 3, 0 },
    0, 12, MST_MERFOLK_AQUAMANCER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 3, 0 },
    4, 12, MST_NO_SPELLS, MABIL_ENTRANCE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// rotting monsters ('n')
{
    ...
    { 5, 3, 5, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_ROT, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { 14, 8, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_NONE, CE_ROT, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_CORPSES, SIZE_MEDIUM
},

{
    ...
    { 10, 3, 5, 0 },
    5, 7, MST_NO_SPELLS, MABIL_NONE, CE_ROT, Z_NOZOMBIE, S_SILENT,
...
// orcs ('o')
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 4, 6, 0 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 4, 0 },
    1, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 4, 0 },
    1, 10, MST_ORC_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { 9, 4, 7, 0 },
    2, 13, MST_NO_SPELLS, MABIL_ORC_BATTLE_CRY, CE_CONTAMINATED, Z_NOZOMBIE,
        S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 15, 4, 7, 0 },
    3, 10, MST_NO_SPELLS, MABIL_ORC_BATTLE_CRY, CE_CONTAMINATED, Z_NOZOMBIE,
        S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 9, 2, 3, 0 },
    5, 12, MST_ORC_SORCERER, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 3, 4, 0 },
    1, 12, MST_ORC_HIGH_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
{ // never spawns
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 0, 0 },
    0, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// dangerous, but still come out at 200+ XP
{
    ...
    { 7, 3, 5, 0 },
    3, 13, MST_NO_SPELLS, MABIL_BLINK, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 7, 3, 5, 0 },
    0, 17, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 3, 5, 0 },
    0, 14, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// player ghost - stats are stored in ghost struct
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 2, 3, 0 },
    // MABIL_NONE here, but mon-abil.cc will sometimes substitute
    // MABIL_DRACONIAN_BREATH manually.
    1, 2, MST_GHOST, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { 3, 3, 5, 0 },
    12, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    M_SPEAKS | M_SEE_INVIS | M_INSUBSTANTIAL | M_SPELLCASTER | M_ACTUAL_SPELLS | M_BATTY,
    mrd(MR_RES_COLD, 3),
    0, 20, MONS_WRAITH, MONS_SILENT_SPECTRE, MH_UNDEAD, -4,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    5, 15, MST_SILENT, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 30, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    MONS_SILENT_DISCIPLE, 'p', CYAN, "silent disciple",
    M_SPEAKS | M_SEE_INVIS | M_INSUBSTANTIAL | M_SPELLCASTER | M_ACTUAL_SPELLS | M_BATTY,
    MR_RES_POISON,
    0, 20, MONS_SPIRIT, MONS_SILENT_DISCIPLE, MH_HOLY, -4,
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    5, 15, MST_SILENT, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 30, DEFAULT_ENERGY,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 5, 5, 0 },
    3, 19, MST_SPIRIT, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// never spawned as a monster.
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 2, 3, 0 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 5, 6, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 5, 7, 0 },
    2, 12, MST_BK_TROG, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 5, 6, 0 },
    2, 12, MST_BK_YREDELEMNUL, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 11, 5, 4, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// rodents ('r')
{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 1, 3, 0 },
    1, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 5, 0 },
    2, 13, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 3, 6, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SILENT,
...

{
    ...
    { 2, 3, 5, 0 },
    5, 11, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},

{
    ...
    { 3, 3, 5, 0 },
    7, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_ROAR,
    I_ANIMAL, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    5, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_ROAR,
    I_ANIMAL, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},
...
// spiders and insects ('s')
{
    ...
    { 1, 3, 4, 0 },
    3, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { 2, 3, 5, 0 },
    1, 7, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { 2, 3, 3, 0 },
    2, 14, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 3, 3, 5, 0 },
    5, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 11, 3, 5, 0 },
    5, 8, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 3, 3, 5, 0 },
    3, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_HISS,
...

{
    ...
    { 4, 3, 5, 0 },
    3, 14, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_HISS,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 5, 3, 5, 0 },
    6, 12, MST_JUMPING_SPIDER, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_HISS,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 8, 3, 5, 0 },
    3, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_HISS,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { 6, 3, 5, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},

{
    ...
    { {AT_HIT, AF_PLAIN, 13}, {AT_HIT, AF_PLAIN, 13}, {AT_HIT, AF_PLAIN, 13},
       AT_NO_ATK },
    { 9, 3, 5, 0 },
    10, 6, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_SCREAM,
...
// testudines and crocodiles ('t')
{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    1, 11, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 30}, {AT_TAIL_SLAP, AF_PLAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 12, 3, 6, 0 },
    5, 9, MST_ALLIGATOR, MABIL_NONE, CE_CLEAN, Z_BIG, S_SILENT,
...

{
    ...
    16, 5, MST_NO_SPELLS, MABIL_WITHDRAW, CE_CLEAN, Z_BIG, S_HISS,
...

{
    ...
    { 16, 7, 4, 0 },
    19, 1, MST_NO_SPELLS, MABIL_WITHDRAW, CE_CLEAN, Z_BIG, S_HISS,
...

{
    ...
    { 8, 4, 5, 0 },
    9, 6, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_POISON_CONTAM, Z_SMALL, S_SILENT,
...
// ugly things ('u')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    3, 10, MST_NO_SPELLS, MABIL_UGLY_THING_MUTATE, CE_MUTAGEN_RANDOM,
        Z_NOZOMBIE, S_GURGLE,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_UGLY_THING_MUTATE, CE_MUTAGEN_RANDOM,
        Z_NOZOMBIE, S_GURGLE,
    I_ANIMAL, HT_LAND, FL_NONE, 11, ACTION_ENERGY(11),
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
// vortices ('v')
{
    ...
    { 3, 3, 5, 0 },
    0, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 2, 3, 0 },
    0, 12, MST_STORM_DRAGON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 6, 1, 2, 0 },
    5, 20, MST_NO_SPELLS, MABIL_BLINK, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_PLANT, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...
// worms ('w')
{
    ...
    { {AT_BITE, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    1, 5, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 6, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 3, 0 },
    1, 5, MST_BRAIN_WORM, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
    I_INSECT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 5, 5, 5, 0 },
    3, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_SMALL, S_SILENT,
...

{
    ...
    { 12, 3, 5, 0 },
    10, 6, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_SILENT,
...

{
    ...
    { 6, 5, 5, 0 },
    5, 15, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SILENT,
...
// small abominations ('x')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    5, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// flying insects ('y')
{
    ...
    { 4, 3, 5, 0 },
    5, 14, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 5, 3, 5, 0 },
    2, 15, MST_NO_SPELLS, MABIL_NONE, CE_ROT, Z_NOZOMBIE, S_BUZZ,
...

{
    ...
    { 8, 3, 5, 0 },
    7, 14, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_BUZZ,
    I_PLANT, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},

{
    ...
    { 10, 3, 5, 0 },
    10, 10, MST_NO_SPELLS, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    0, 10, MST_NO_SPELLS, MABIL_INCITE, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT,
    I_INSECT, HT_LAND, FL_FLY, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...
// or else are chosen randomly
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 5, 5, 0 },
    0, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    10, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 3, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 5, 3, 0 },
    15, 10, MST_SKELETAL_WARRIOR, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    10, 17, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
...

{
    ...
    { 8, 3, 5, 0 },
    12, 13, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
    I_ANIMAL, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// placed in the Crypt.
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 0, 0, 66 },
    40, 3, MST_CURSE_SKULL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...
// Curse toes move at half the speed with which they attack.
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 77 },
    50, 1, MST_CURSE_TOE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
...
// angelic beings ('A')
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK,
       AT_NO_ATK },
    { 12, 6, 5, 0 },
    10, 20, MST_ANGEL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK,
       AT_NO_ATK },
    { 9, 6, 5, 0 },
    10, 20, MST_NO_SPELLS, MABIL_HYMN, CE_NOCORPSE, Z_NOZOMBIE, S_CHERUB,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK,
       AT_NO_ATK },
    { 14, 6, 5, 0 },
    10, 13, MST_DAEVA, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_VAMPIRIC, 25}, {AT_HIT, AF_DRAIN_XP, 10}, AT_NO_ATK,
       AT_NO_ATK },
    { 18, 6, 5, 0 },
    10, 20, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
...
// beetles ('B')
{
    ...
    { 5, 7, 6, 0 },
    10, 3, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
...

{
    ...
    { 9, 3, 5, 0 },
    20, 2, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SILENT,
...

{
    ...
    { 8, 3, 5, 0 },
    13, 4, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SILENT,
...
// cyclopes and giants ('C')
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 3, 5, 0 },
    3, 4, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { 9, 3, 5, 0 },
    5, 3, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SHOUT,
...

{
    ...
    { 12, 3, 5, 0 },
    9, 4, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT2,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 3, 6, 0 },
    8, 4, MST_EFREET, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 4, 5, 0 },
    9, 3, MST_FROST_GIANT, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { 16, 3, 5, 0 },
    12, 2, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { 20, 3, 5, 0 },
    10, 3, MST_TITAN, MABIL_NONE, CE_CLEAN, Z_BIG, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...
// dragons ('D')
{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    5, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SILENT,
...

{
    ...
    { 12, 5, 5, 0 },
    10, 8, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_CLEAN, Z_BIG, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
    0, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_ROAR,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { 12, 5, 5, 0 },
    10, 8, MST_NO_SPELLS, MABIL_COLD_BREATH, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 4, 5, 5, 0 },
    5, 10, MST_STEAM_DRAGON, MABIL_NONE, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { 9, 5, 5, 0 },
    7, 7, MST_SWAMP_DRAGON, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 5, 3, 5, 0 },
    5, 10, MST_MOTTLED_DRAGON, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { 16, 3, 5, 0 },
    10, 15, MST_QUICKSILVER_DRAGON, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
...

{
    ...
    { 18, 5, 3, 0 },
    20, 6, MST_IRON_DRAGON, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_ROAR,
...

{
    ...
    { 14, 5, 5, 0 },
    13, 10, MST_STORM_DRAGON, MABIL_NONE, CE_CLEAN, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 18, 4, 4, 0 },
    15, 7, MST_GOLDEN_DRAGON, MABIL_NONE, CE_POISONOUS, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 17, 5, 5, 0 },
    15, 10, MST_SHADOW_DRAGON, MABIL_NONE, CE_ROT, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { {AT_BITE, AF_PLAIN, 30}, {AT_CLAW, AF_PLAIN, 20},
      {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK },
    { 20, 8, 8, 0 },
    20, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 18, 4, 5, 0 },
    10, 15, MST_PEARL_DRAGON, MABIL_NONE, CE_CLEAN, Z_BIG, S_ROAR,
    I_ANIMAL, HT_LAND, FL_FLY, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},
...
// elementals (E)
{
    ...
    { 6, 5, 5, 0 },
    14, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 6, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { 6, 3, 5, 0 },
    4, 12, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 5, 3, 0 },
    0, 7, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
    2, 18, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 6, 6, 0 },
    20, 2, MST_IRON_ELEMENTAL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 6, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},
...
// frogs ('F')
{
    ...
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size
    0, 12, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_CROAK,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    2, 11, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_CROAK,
...

{
    ...
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size
    6, 9, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_BIG, S_CROAK,
    I_ANIMAL, HT_AMPHIBIOUS, FL_NONE, 12, SWIM_ENERGY(6),
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 6, 3, 5, 0 },
    0, 16, MST_NO_SPELLS, MABIL_BLINK, CE_CLEAN, Z_SMALL, S_CROAK,
...
// eyes ('G')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    0, 1, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    3, 1, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    2, 4, MST_GIANT_ORANGE_BRAIN, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    10, 3, MST_GREAT_ORB_OF_EYES, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    3, 1, MST_SHINING_EYE, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    12, 1, MST_EYE_OF_DEVASTATION, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 1, 2, 0 },
    0, 20, MST_NO_SPELLS, MABIL_GOLDEN_EYE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 4, 5, 0 },
    10, 10, MST_OPHAN, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// hybrids ('H')
{
    ...
    { {AT_BITE, AF_PLAIN, 10}, {AT_PECK, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8},
       AT_NO_ATK },
    { 7, 3, 5, 0 },
    2, 7, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SCREECH,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 14}, {AT_CLAW, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8},
       AT_NO_ATK },
    { 9, 3, 5, 0 },
    5, 7, MST_NO_SPELLS, MABIL_HURL_SPINES, CE_CONTAMINATED, Z_BIG, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size.
    5, 7, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_BELLOW,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_BITE, AF_PLAIN, 18}, {AT_PECK, AF_PLAIN, 10},
      {AT_CLAW, AF_PLAIN, 10}, AT_NO_ATK },
    { 12, 3, 5, 0 },
    4, 6, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SCREECH,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 12}, {AT_HIT, AF_PLAIN, 12},
       AT_NO_ATK },
    { 16, 3, 5, 0 },
    5, 5, MST_SPHINX, MABIL_NONE, CE_CLEAN, Z_BIG, S_SHOUT,
...

{
    ...
    // XXX: Will be Z_SMALL, but is Z_BIG until code for zombie spawns
    // is no longer based on zombie size.
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SCREECH,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, {AT_PECK, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    { 5, 3, 5, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN /*chicken*/, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 13, 6, 5, 0 },
    2, 10, MST_SHEDU, MABIL_NONE, CE_CLEAN, Z_BIG, S_SCREECH,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { 5, 3, 5, 0 },
    3, 13, MST_NO_SPELLS, MABIL_TOGGLE_INVIS, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
    I_ANIMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// jellies ('J')
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    1, 3, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 3, 5, 5, 0 },
    0, 2, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 11, 3, 5, 0 },
    1, 4, MST_NO_SPELLS, MABIL_SLIME_SPLIT_MERGE, CE_NOCORPSE,
        Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 10, 3, 5, 0 },
    2, 6, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 5, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 3, 5, 0 },
    0, 4, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_AMPHIBIOUS, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 7, 3, 5, 0 },
    10, 1, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_COLD, 12}, {AT_HIT, AF_COLD, 12}, {AT_HIT, AF_PLAIN, 12},
      {AT_HIT, AF_PLAIN, 12} },
    { 15, 3, 5, 0 },
    5, 10, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 11, 3, 3, 0 },
    2, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 18, 3, 5, 0 },
    1, 3, MST_NO_SPELLS, MABIL_SPIT_ACID, CE_POISON_CONTAM, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_ITEMS, SIZE_SMALL
},
...
// kobolds ('K')
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 2, 3, 0 },
    2, 12, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    3, 12, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    2, 13, MST_KOBOLD_DEMONOLOGIST, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},
...
// liches ('L')
{
    ...
    { 20, 2, 4, 0 },
    10, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 27, 2, 4, 0 },
    20, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 30, 3, 5, 0 },
    20, 15, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...
// mummies ('M')
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 5, 3, 0 },
    3, 6, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 6, 5, 3, 0 },
    1, 9, MST_BOG_MUMMY, MABIL_ROT, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 5, 3, 0 },
    6, 9, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 5, 3, 100 },
    10, 6, MST_MUMMY, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 5, 3, 0 },
    8, 7, MST_MUMMY, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// nagas ('N')
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    6, 10, MST_NAGA, MABIL_NONE, CE_POISONOUS, Z_BIG, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    6, 10, MST_NAGA_MAGE, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, ACTION_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 10, 9, 2, 0 },
    6, 10, MST_NAGA, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, ACTION_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},
...
// ogres ('O')
{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    1, 6, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
...
// that they wield two weapons... I'm raising their xp modifier. - bwr
{
    ...
    { 6, 3, 5, 0 },
    1, 4, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT2,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    1, 7, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},
...
// plants ('P')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    10, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 0, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    10, 0, MST_NO_SPELLS, MABIL_SPIT_ACID, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 20, 3, 5, 0 },
    15, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 0, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    10, 0, MST_NO_SPELLS, MABIL_THROW_FLAME, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},
...
// rakshasas and efreeti ('R')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    10, 5, MST_EFREET, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    10, 14, MST_RAKSHASA, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// fake R - conjured by the R's illusion spell.
{
    ...
    { 1, 0, 0, 1 },
    0, 30, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// snakes ('S')
{
    ...
    { 1, 2, 3, 0 },
    0, 11, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_POISON, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    1, 15, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { 4, 3, 5, 0 },
    2, 15, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_HISS,
...

{
    ...
    { {AT_BITE, AF_POISON_MEDIUM, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    4, 15, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_HISS,
...

{
    ...
    { 6, 3, 5, 0 },
    4, 14, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_SMALL, S_HISS,
    I_REPTILE, HT_LAND, FL_NONE, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...

{
    ...
    { 11, 3, 5, 0 },
    4, 16, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_HISS,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    6, 14, MST_GUARDIAN_SERPENT, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// trolls ('T')
{
    ...
    { {AT_BITE, AF_PLAIN, 20}, {AT_CLAW, AF_PLAIN, 15},
      {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK },
    { 7, 3, 5, 0 },
    3, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 11, 3, 5, 0 },
    13, 6, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 16, 3, 5, 0 },
    20, 4, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { {AT_BITE, AF_PLAIN, 27}, {AT_CLAW, AF_PLAIN, 20},
      {AT_CLAW, AF_PLAIN, 20}, AT_NO_ATK },
    { 10, 3, 5, 0 },
    6, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
// bears ('U')
{
    ...
    { {AT_BITE, AF_PLAIN, 12}, {AT_CLAW, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8},
       AT_NO_ATK },
    { 7, 4, 4, 0 },
    5, 8, MST_BERSERK_ESCAPE, MABIL_NONE, CE_CLEAN, Z_BIG, S_GROWL,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 20}, {AT_CLAW, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    { 7, 5, 3, 0 },
    7, 8, MST_BERSERK_ESCAPE, MABIL_NONE, CE_CLEAN, Z_BIG, S_GROWL,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 4}, {AT_CLAW, AF_PLAIN, 4}, {AT_CLAW, AF_PLAIN, 4},
       AT_NO_ATK },
    { 6, 3, 3, 0 },
    2, 8, MST_BERSERK_ESCAPE, MABIL_NONE, CE_CLEAN, Z_SMALL, S_GROWL,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// vampires ('V')
{
    ...
    { {AT_HIT, AF_PLAIN, 7}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 6, 3, 5, 0 },
    10, 10, MST_VAMPIRE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 33}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 11, 3, 7, 0 },
    10, 10, MST_VAMPIRE_KNIGHT, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 8, 3, 4, 0 },
    10, 10, MST_VAMPIRE_MAGE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// wraiths ('W')
{
    ...
    { 6, 3, 5, 0 },
    10, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 10, 3, 5, 0 },
    7, 7, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_DRAIN_XP, 13}, {AT_HIT, AF_DRAIN_STAT, 13}, AT_NO_ATK,
       AT_NO_ATK },
    { 13, 3, 5, 0 },
    12, 10, MST_EIDOLON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// spectral thing - similar to zombies/skeletons
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 3, 5, 0 },
    8, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { 25, 3, 5, 0 },
    5, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 3, 5, 0 },
    13, 13, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// yaks, sheep and elephants ('Y')
{
    ...
    { {AT_BITE, AF_PLAIN, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    2, 7, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_BELLOW,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 7, 3, 5, 0 },
    4, 7, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_BELLOW,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 14, 3, 5, 0 },
    9, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_BELLOW,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},

{
    ...
    { {AT_TRAMPLE, AF_PLAIN, 20}, {AT_TRUNK_SLAP, AF_PLAIN, 5}, AT_NO_ATK,
       AT_NO_ATK },
    { 9, 5, 5, 0 },
    8, 2, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_TRUMPET,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { {AT_TRAMPLE, AF_PLAIN, 40}, {AT_TRUNK_SLAP, AF_PLAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 15, 5, 5, 0 },
    13, 2, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_TRUMPET,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { 20, 5, 7, 0 },
    13, 10, MST_HELLEPHANT, MABIL_NONE, CE_CLEAN, Z_BIG, S_TRUMPET,
    I_ANIMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { 16, 5, 5, 0 },
    9, 5, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_BIG, S_SILENT,
    I_ANIMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    10, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// water monsters
{
    ...
    { {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 3, 5, 0 },
    1, 12, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    5, 7, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_WATER, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    1, 15, MST_NO_SPELLS, MABIL_LIGHTNING_BOLT, CE_CLEAN, Z_SMALL, S_SILENT,
    I_ANIMAL, HT_WATER, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_STING, AF_POISON_STR, 1}, {AT_HIT, AF_PLAIN, 1}, AT_NO_ATK,
       AT_NO_ATK },
    { 4, 3, 5, 0 },
    0, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SILENT,
...
// of bone or similar materials (e.g. chitin)
{
    ...
    { 7, 3, 5, 0 },
    9, 5, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SILENT,
    I_ANIMAL, HT_WATER, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_BIG
},
...
// A kraken and its tentacles get a random colour from ETC_KRAKEN.
{
    ...
    { 16, 10, 6, 0 },
    20, 0, MST_KRAKEN, MABIL_NONE, CE_POISON_CONTAM, Z_BIG, S_SILENT,
...

{
    ...
    { 12, 3, 2, 0 },
    5, 7, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// lava monsters
{
    ...
    { 6, 3, 5, 0 },
    1, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_SMALL, S_SILENT,
...

{
    ...
    { 4, 3, 5, 0 },
    4, 15, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_SMALL, S_SILENT,
...

{
    ...
    { 3, 3, 5, 0 },
    2, 17, MST_NO_SPELLS, MABIL_SPIT_LAVA, CE_NOCORPSE, Z_SMALL, S_HISS,
    I_ANIMAL, HT_LAVA, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...
{   // mv: was another lava thing
    ...
    { 14, 3, 5, 0 },
    5, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_SMALL, S_SILENT,
...
// monsters moving through rock
{
    ...
    { 5, 5, 5, 0 },
    3, 12, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_BIG, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 4, 5, 0 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
    1, 13, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { 20, 5, 5, 0 },
    10, 15, MST_NO_SPELLS, MABIL_BLINK, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 4, 5, 0 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_SMALL, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// mimics
{
    ...
    { {AT_HIT, AF_POISON, 12}, {AT_HIT, AF_PLAIN, 12}, {AT_HIT, AF_PLAIN, 12},
       AT_NO_ATK },
    { 8, 3, 5, 0 },
    5, 1, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...

{
    ...
    { {AT_HIT, AF_POISON, 12}, {AT_HIT, AF_PLAIN, 12}, {AT_HIT, AF_PLAIN, 12},
       AT_NO_ATK },
    { 8, 3, 5, 0 },
    15, 1, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},
...
// Demonic tentacle things.
{
    ...
    { {AT_TENTACLE_SLAP, AF_CHAOS, 30}, {AT_CLAW, AF_CHAOS, 40}, AT_NO_ATK,
       AT_NO_ATK },
    { 16, 5, 5, 0 },
    13, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// note: these things regenerate
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 3, 0 },
    3, 14, MST_NO_SPELLS, MABIL_BLINK, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { 3, 2, 6, 0 },
    5, 17, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
...

{
    ...
    { 2, 3, 5, 0 },
    4, 10, MST_WHITE_IMP, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 3}, {AT_HIT, AF_PLAIN, 3},
       AT_NO_ATK },
    { 2, 3, 5, 0 },
    1, 12, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_NORMAL, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 1, 4, 6, 0 },
    2, 15, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 3, 5, 0 },
    6, 8, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 2, 3, 5, 0 },
    4, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 2, 3, 5, 0 },
    3, 11, MST_SHADOW_IMP, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LITTLE
},
...
// devils etc. ('4')
{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    14, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 8, 3, 5, 0 },
    16, 8, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREECH,
    I_HIGH, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, {AT_STING, AF_POISON_STAT, 10}, AT_NO_ATK,
       AT_NO_ATK },
    { 8, 4, 5, 0 },
    3, 7, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREECH,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_ROT, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 3, 5, 0 },
    2, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 7, 3, 5, 0 },
    7, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { 7, 3, 5, 0 },
    2, 20, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { 7, 4, 5, 0 },
    8, 10, MST_HELLWING, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
// middle demons ('3')
{
    ...
    { {AT_HIT, AF_FIRE, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    10, 12, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { 11, 3, 5, 0 },
    18, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
},

{
    MONS_ICE_DEVIL, '3', BLUE, "ice devil",
    M_NO_FLAGS,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
...

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    { 7, 3, 5, 0 },
    5, 9, MST_SMOKE_DEMON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
    4, 12, MST_NEQOXEC, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 3, 5, 0 },
    3, 10, MST_YNOXINUL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_BELLOW,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 6, 3, 5, 0 },
    7, 12, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_RANDOM,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 3, 5, 0 },
    7, 12, MST_SHADOW_DEMON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_CROAK,
    I_HIGH, HT_LAND, FL_NONE, 11, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 3, 5, 0 },
    5, 7, MST_GREEN_DEATH, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_NONE, 11, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 12, 3, 5, 0 },
    10, 10, MST_BLIZZARD_DEMON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 11, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 14, 3, 5, 0 },
    5, 12, MST_BALRUG, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 11, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 13, 5, 5, 0 },
    11, 10, MST_CACODEMON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
{   // with randomised stats
    ...
    { 7, 9, 6, 0 },
    0, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_RANDOM,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 7, 3, 5, 0 },
    5, 10, MST_HELLION, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
    I_HIGH, HT_LAND, FL_NONE, 12, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 3, 5, 0 },
    15, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 12, 3, 5, 0 },
    10, 12, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 7, 3, 5, 0 },
    12, 12, MST_TORMENTOR, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
...
// fiends, etc. ('1')
{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_RES_HELLFIRE | MR_VUL_COLD,
    0, 18, MONS_BRIMSTONE_FIEND, MONS_BRIMSTONE_FIEND, MH_DEMONIC, -12,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    { 18, 3, 5, 0 },
    15, 6, MST_FIEND, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    M_SPELLCASTER | M_SEE_INVIS | M_GLOWS_LIGHT,
    MR_RES_POISON | MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    0, 10, MONS_ICE_FIEND, MONS_ICE_FIEND, MH_DEMONIC, -12,
    { {AT_CLAW, AF_COLD, 25}, {AT_CLAW, AF_COLD, 25}, AT_NO_ATK, AT_NO_ATK },
    { 18, 3, 5, 0 },
    15, 6, MST_ICE_FIEND, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 18, 3, 5, 0 },
    15, 6, MST_SHADOW_FIEND, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    0, 18, MONS_PIT_FIEND, MONS_PIT_FIEND, MH_DEMONIC, -12,
    { {AT_HIT, AF_PLAIN, 28}, {AT_HIT, AF_PLAIN, 21}, {AT_HIT, AF_PLAIN, 21},
       AT_NO_ATK },
    { 19, 4, 5, 0 },
    17, 5, MST_PIT_FIEND, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    { 12, 3, 5, 0 },
    10, 15, MST_EXECUTIONER, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
...
{ // dummy for the genus, never spawns
    ...
    { 8, 7, 3, 0 },
    7, 5, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 6, 3, 0 },
    5, 6, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 28}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 7, 4, 0 },
    12, 4, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 15, 7, 4, 0 },
    15, 3, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 7, 4, 0 },
    22, 3, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_NONE, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { {AT_HIT, AF_ELEC, 15}, {AT_HIT, AF_ELEC, 15}, {AT_HIT, AF_PLAIN, 15},
      {AT_HIT, AF_PLAIN, 15} },
    { 15, 7, 4, 0 },
    5, 20, MST_ELECTRIC_GOLEM, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...
// statues and statue-like things (also '8')
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 0, 0, 70 },
    12, 1, MST_ICE_STATUE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 16, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 150 },
    15, 1, MST_NO_SPELLS, MABIL_SUMMON_DEMONS, CE_NOCORPSE, Z_NOZOMBIE,
        S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 0, 0, 160 },
    20, 1, MST_NO_SPELLS, MABIL_INFLICT_DIV_MISCAST, CE_NOCORPSE, Z_NOZOMBIE,
        S_SILENT,
...
{ // always redefined
    ...
    { 8, 0, 0, 70 },
    12, 1, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LARGE
},
...
// These things have nonzero speed so they can scream at you.
{
    MONS_SCREAMING_STATUE, '8', LIGHTGREY, "screaming statue",
    M_ARTIFICIAL | M_NO_EXP_GAIN | M_STATIONARY | M_SPEAKS,
    mrd(MR_RES_POISON | MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 2),
    0, 10, MONS_STATUE, MONS_SCREAMING_STATUE, MH_NONLIVING, MAG_IMMUNE,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 8, 0, 0, 100 },
    0, 0, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 4, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// gargoyles ('9')
{
    ...
    { {AT_BITE, AF_PLAIN, 10}, {AT_CLAW, AF_PLAIN, 6}, {AT_CLAW, AF_PLAIN, 6},
       AT_NO_ATK },
    { 4, 3, 5, 0 },
    18, 6, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_BITE, AF_FIRE, 12}, {AT_CLAW, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8},
       AT_NO_ATK },
    { 5, 3, 5, 0 },
    14, 7, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Random demon in pan - only one per level.  Stats are stored in ghost struct.
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 19, 0, 8, 100 },
    1, 2, MST_GHOST, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_DEMON_TAUNT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
// explodey things / orb of fire ('*')
{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 1 },
    0, 10, MST_STORM_DRAGON, MABIL_LIGHTNING_DETONATE, CE_NOCORPSE, Z_NOZOMBIE,
        S_SILENT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 1}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 1 },
    0, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_PLANT, HT_LAND, FL_LEVITATE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
    20, 20, MST_ORB_OF_FIRE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 77 },
    50, 1, MST_BLESSED_TOE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
    20, 20, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_LEVITATE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LITTLE
},
...
// other symbols
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 4, 5, 0 },
    10, 15, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
...
// "A"ngels.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK,
       AT_NO_ATK },
    { 19, 0, 0, 150 },
    15, 20, MST_MENNAS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_FLY, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "c"entaurs.
{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 0, 0, 72 },
    4, 8, MST_NESSOS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},
...
// "C"yclopses and giants.
{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 120 },
    14, 2, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 22, 0, 0, 220 },
    18, 2, MST_IRON_GIANT, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { 12, 0, 0, 105 },
    7, 3, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_GIANT
},
...
// Antaeus is now demonic so that he'll resist torment. - bwr
{
    ...
    { 22, 0, 0, 700 },
    28, 4, MST_ANTAEUS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...
// "d"raconians.
{
    ...
    { {AT_HIT, AF_PLAIN, 60}, {AT_TAIL_SLAP, AF_PLAIN, 45}, AT_NO_ATK,
       AT_NO_ATK },
    { 22, 0, 0, 380 },
    25, 10, MST_NO_SPELLS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "D"ragons and hydras.
{
    ...
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 17},
      {AT_TRAMPLE, AF_PLAIN, 20}, AT_NO_ATK },
    { 19, 0, 0, 133 },
    15, 7, MST_NO_SPELLS, MABIL_FIRE_BREATH, CE_CONTAMINATED, Z_NOZOMBIE,
        S_ROAR,
    I_NORMAL, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_HUGE
},

{
    ...
    { {AT_BITE, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 30, 0, 0, 150 },
    0, 5, MST_NO_SPELLS, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_ROAR,
    I_REPTILE, HT_AMPHIBIOUS, FL_NONE, 10, SWIM_ENERGY(6),
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { {AT_BITE, AF_PLAIN, 35}, {AT_CLAW, AF_PLAIN, 15},
      {AT_TRAMPLE, AF_PLAIN, 15}, AT_NO_ATK },
    { 20, 4, 4, 0 },
    12, 9, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_ROAR,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 0, 0, 25 },
    0, 13, MST_DOWAN, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "F"rogs.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 40 },
    0, 16, MST_PRINCE_RIBBIT, MABIL_BLINK, CE_CONTAMINATED, Z_NOZOMBIE, S_CROAK,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 0, 0, 40 },
    2, 9, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_GROWL,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Spr"i"ggans.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 0, 0, 100 },
    0, 20, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...
// "J"ellies.
{
    ...
    { 21, 0, 0, 230 },
    8, 4, MST_NO_SPELLS, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_ACID, 50}, {AT_HIT, AF_ACID, 30}, AT_NO_ATK, AT_NO_ATK },
    { 12, 0, 0, 180 },
    10, 1, MST_DISSOLUTION, MABIL_NONE, CE_POISON_CONTAM, Z_NOZOMBIE, S_SILENT,
    I_NORMAL, HT_LAND, FL_NONE, 8, DEFAULT_ENERGY,
...
// Snails and other gastropods.
{
    ...
    { {AT_BITE, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 20, 0, 0, 150 },
    2, 1, MST_GASTRONOK, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_GURGLE,
...
// "K"obolds.
{
    ...
    { {AT_HIT, AF_PLAIN, 9}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    { 6, 0, 0, 30 },
    2, 24, MST_SONJA, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 14, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_SMALL
},

{
    ...
    { {AT_HIT, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 40 },
    4, 12, MST_NO_SPELLS, MABIL_NONE, CE_POISONOUS, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "L"iches.
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_TOUCH, AF_DRAIN_XP, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 22, 0, 0, 154 },
    12, 10, MST_BORIS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "M"ummies.
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 0, 0, 24 },
    3, 6, MST_MENKAURE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 6, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 240 },
    10, 6, MST_KHUFU, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "m"erfolk.
{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 0, 0, 150 },
    5, 18, MST_ILSUIW, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...
// "O"gres.
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 54 },
    3, 7, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},
...
// "o"rcs.
{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 0, 0, 32 },
    0, 9, MST_ORC_WIZARD_III, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 6, 0, 0, 66 },
    0, 11, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 10, 0, 0, 60 },
    9, 11, MST_NERGALLE, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 200 },
    3, 10, MST_DAEVA, MABIL_ORC_BATTLE_CRY, CE_CONTAMINATED, Z_NOZOMBIE,
        S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "p"  ghostlies.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 140 },
    7, 25, MST_TERPSICHORE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Dwarves
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 17, 0, 0, 140 },
    1, 10, MST_BK_OKAWARU, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Rakshasas and demons.
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 0, 0, 88 },
    10, 5, MST_DRAC_SCORCHER, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 140 },
    10, 14, MST_MARA, MABIL_BLINK, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Mara.
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 140 },
    10, 14, MST_MARA_FAKE, MABIL_BLINK, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// "S"nakes and guardian serpents.
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 142 },
    8, 18, MST_AIZUL, MABIL_NONE, CE_MUTAGEN_RANDOM, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_LARGE
},
...
// "T"rolls.
{
    ...
    { {AT_BITE, AF_PLAIN, 20}, {AT_CLAW, AF_PLAIN, 15},
      {AT_CLAW, AF_PLAIN, 15}, AT_NO_ATK },
    { 8, 0, 0, 96 },
    0, 10, MST_NO_SPELLS, MABIL_BERSERK, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},
...
// "V"ampires.
{
    ...
    { {AT_HIT, AF_PLAIN, 40}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    { 18, 0, 0, 110 },
    10, 15, MST_JORY, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// Elephants.
{
    ...
    { {AT_TRAMPLE, AF_PLAIN, 45}, {AT_BITE, AF_PLAIN, 20},
      {AT_GORE, AF_PLAIN, 15 }, AT_NO_ATK },
    { 20, 0, 0, 240 },
    13, 10, MST_HELLEPHANT, MABIL_NONE, CE_CLEAN, Z_NOZOMBIE, S_TRUMPET,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_GIANT
},
...
// Skulls and "z" undead.
{
    ...
    { 14, 0, 0, 180 },
    30, 10, MST_CURSE_SKULL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, MONEAT_NOTHING, SIZE_TINY
},
...
// numbers!
{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 15},
       AT_NO_ATK },
    { 18, 0, 0, 250 },
    10, 15, MST_IGNACIO, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 20, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 6, 0, 0, 40 },
    3, 11, MST_GRINDER, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LITTLE
},

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 180 },
    20, 0, MST_ROXANNE, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_LARGE
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1, 0, 0, 10 },
    0, 10, MST_JESSICA, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 3, 0, 0, 30 },
    0, 11, MST_ORC_WIZARD_II, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 5, 0, 0, 39 },
    0, 12, MST_ORC_WIZARD_III, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 13, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 14, 0, 0, 84 },
    3, 10, MST_NO_SPELLS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 0, 0, 64 },
    0, 11, MST_WIZARD_II, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 0, 0, 69 },
    0, 10, MST_NECROMANCER_I, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 9, 0, 0, 76 },
    0, 8, MST_HAROLD, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 11, 0, 0, 90 },
    0, 9, MST_GUARDIAN_SERPENT, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 13, 0, 0, 106 },
    0, 10, MST_WIZARD_IV, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 14, 0, 0, 121 },
    0, 10, MST_ORC_HIGH_PRIEST, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 0, 0, 123 },
    0, 10, MST_RUPERT, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 18}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 0, 0, 110 },
    0, 10, MST_KIRKE, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 20, 0, 0, 214 },
    1, 9, MST_NORRIS, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 21, 0, 0, 159 },
    0, 10, MST_FREDERICK, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 22, 0, 0, 164 },
    0, 10, MST_EFREET, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 4, 0, 0, 40 },
    0, 13, MST_EUSTACHIO, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { 5, 0, 0, 60 },
    1, 13, MST_MAURICE, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 190 },
    1, 9, MST_NIKOLA, MABIL_NONE, CE_CONTAMINATED, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_MEDIUM
},
...
// unique major demons ('&')
{
    ...
    { 17, 0, 0, 350 },
    10, 25, MST_MNOLEG, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_BUZZ,
    I_HIGH, HT_LAND, FL_NONE, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { 19, 0, 0, 360 },
    10, 20, MST_LOM_LOBON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SCREAM,
    I_HIGH, HT_LAND, FL_LEVITATE, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 60}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 21, 0, 0, 650 },
    30, 8, MST_CEREBOV, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { {AT_HIT, AF_PLAIN, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 16, 0, 0, 350 },
    10, 10, MST_GLOORX_VLOQ, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_MOAN,
...

{
    ...
    { 15, 0, 0, 300 },
    15, 6, MST_GERYON, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_ROAR,
    I_NORMAL, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, MONEAT_NOTHING, SIZE_GIANT
},

{
    ...
    { 16, 0, 0, 450 },
    40, 3, MST_DISPATER, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_NONE, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 50}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 17, 0, 0, 450 },
    30, 7, MST_ASMODEUS, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
    I_HIGH, HT_LAND, FL_FLY, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, MONEAT_NOTHING, SIZE_LARGE
},

{
    ...
    { {AT_HIT, AF_PLAIN, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 18, 0, 0, 250 },
    10, 30, MST_ERESHKIGAL, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SHOUT,
...
// over and over.
{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    { 1000, 1000, 0, 0 },
    127, 127, MST_TEST_SPAWNER, MABIL_NONE, CE_NOCORPSE, Z_NOZOMBIE, S_SILENT,
