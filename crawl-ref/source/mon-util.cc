...
{
    std::vector<mon_spellbook_type> books;
    ...
    case MONS_DEEP_ELF_CONJURER:
        books.push_back(MST_DEEP_ELF_CONJURER_I);
        books.push_back(MST_DEEP_ELF_CONJURER_II);
        break;
    ...
    case MONS_PRIMORDIAL_LICH:
        books.push_back(MST_PRIMORDIAL_LICH_I);
        books.push_back(MST_PRIMORDIAL_LICH_II);
        break;
    ...
    case MONS_DEEP_DWARF_NECROMANCER:
        books.push_back(MST_DEEP_DWARF_NECROMANCER);
        books.push_back(MST_JESSICA);
        break;

    case MONS_UNBORN_DEEP_DWARF:
        books.push_back(MST_UNBORN_DEEP_DWARF);
        books.push_back(MST_NECROMANCER_I);
        break;
    ...
    case MONS_SERPENT_OF_HELL:
        ...
        {
        case BRANCH_GEHENNA:
            books.push_back(MST_SERPENT_OF_HELL_GEHENNA);
            break;
        case BRANCH_COCYTUS:
            books.push_back(MST_SERPENT_OF_HELL_COCYTUS);
            break;
        case BRANCH_DIS:
            books.push_back(MST_SERPENT_OF_HELL_DIS);
            break;
        case BRANCH_TARTARUS:
            books.push_back(MST_SERPENT_OF_HELL_TARTARUS);
            break;
        default:
            books.push_back(MST_SERPENT_OF_HELL_GEHENNA);
            break;
